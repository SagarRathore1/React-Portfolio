...
const Experience = () => {
  return <div className='border-b border-neutral-900 pb-4 md:pl-24 sm:pl-24'>
    <motion.h1
     ...
     className='my-20 sm:text-center text-center text-4xl  '>Experience</motion.h1>
    <div>
      {EXPERIENCES.map((experience,index) =>(
        <div key={index} className='mb-8 flex flex-wrap lg:justify-center '>
          ...
          <p className='mb-text-sm text-neutral-400'>
            ...
            <h6 className='mb-2 font-semibold sm:pr-24 sm:24'>{experience.role} -{" "} 
              <span className='text-sm text-purple-100 '>
                {experience.company}

              </span>
              </h6>
              <p className='mb-4 text-neutral-400 sm:pr-24 sm:24'>{experience.description}</p>{experience.technologies.map((tech,index)=>(
